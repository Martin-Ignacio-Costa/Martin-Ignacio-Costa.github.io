      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Have a project in mind or want to discuss potential collaborations? Reach out and let's create something amazing together.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                ...
                <button
                  ...
                  className={`w-full px-6 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors flex items-center justify-center gap-2 ${
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@dataportfolio.com" className="hover:underline">hello@dataportfolio.com</a>
                </div>
              </div>
